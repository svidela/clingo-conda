...
RUN conda config --set show_channel_urls true && conda update --yes conda && \
    conda install --yes conda-build=1.21 jinja2 anaconda-client && conda config --add channels conda-forge
